...
INSERT INTO "new_Issue" ("category", "createdAt", "id", "isFavorite", "problem", "solution", "tags", "title") SELECT "category", "createdAt", "id", "isFavorite", "problem", "solution", "tags", "title" FROM "Issue";
DROP TABLE "Issue";
